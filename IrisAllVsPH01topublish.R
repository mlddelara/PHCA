...
maxd <- 1 #maxdimension ideally 1 or 2
maxsc <- 1 #maxscale
...
# rename the dataset
dataset <- iris
#iris <- read.csv("~/Documents/DATAforR/iris/iris.data", header=FALSE)
#View(iris)
#dataset = read.csv("~/Documents/DATAforR/iris/iris.data", header=FALSE)
#dataset = dataset[1:4] 
